                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/27c22373685b57c69399ddbd0/images/524be52d-f3f0-49ab-aebf-94e44bf8df71.png" width="355" style="max-width:710px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnRetinaImage">
...
<h1>Billions Vision<br>
<span style="font-size:14px">Make Your Vision Fly</span></h1>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <p><strong>Billionsvision</strong> is providing a platform for those who want to become an entrepreneur, who possess ideas that can be catered into a professional business through our mentoring and capital acquiring sources. At billionsvision we provide all the entrepreneurs the motivation and support to kick start their business ensuring a bright future. We take serve as a bridge between the business idea generator and entrepreneurs finding the most suitable middle ground.</p>
...
<table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnImageCardBottomContent" width="100%" style="background-color: #404040;">
    <tbody><tr>
        <td class="mcnImageCardBottomImageContent" align="left" valign="top" style="padding-top:0px; padding-right:0px; padding-bottom:0; padding-left:0px;">
            ...
            <img alt="" src="https://gallery.mailchimp.com/27c22373685b57c69399ddbd0/images/07442774-c1ea-47ba-9a17-bac561aadf3e.jpg" width="564" style="max-width:1200px;" class="mcnImage">
    ...
    <tr>
        <td class="mcnTextContent" valign="top" style="padding: 9px 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;" width="546">
            If you have an idea or Fund for&nbsp; Startup. Billions Vision can help you with your Startup Business.<br>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                             ...
                             <!--- Fetching data for view to show on template ----->
                            ...
                            <h3 style="text-align: center;"><span style="color:#003399"><?php echo $template_subject ?></span></h3>
                           
                            
                            <p><?php echo $template_message ;?> .&nbsp;<br>
<br>
&nbsp;</p>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                <a class="mcnButton " title="Let's Start" href="https://billionsvision.com/index.php/Register/index" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Let's Start</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <em>Copyright © 2019 Billions Vision, All rights reserved.</em><br>
Disclaimer: All content rights other than <em>Billions Vision</em> are owned by their respective owners.<br>
Developed by <a href="https://kvmgroupbiz.in/" target="_blank">Kvmgroupbiz</a>&nbsp;<br>
<br>
&nbsp;
                        </td>
                    </tr>
