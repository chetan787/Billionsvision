                  ...
                  <h3 class="page-header"> 
                   <div class="row">
                       <div class="col-lg-4">
                                  ...
                                  <i class="fa fa-inbox" title="Add Email Template" style="font-size:20px;"> Add Email Template</i>
                       </div>
                    <div class="col-lg-8">
                    ...
                    ?>
                        ...
                        <form action="<?php echo base_url()?>index.php/EmaiMessagelTemplate/add_email" method="post" class="register-wthree">
                            <div class="form-group">
                                ...
                                <?php echo form_error('tname',"<p  style='font-size: 12px;' class='text-danger'>","</p>"); ?>
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Enter Subject" name="tsub" required="">
