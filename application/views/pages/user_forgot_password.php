...
<head>
    <title>Billionsvision || Forgot Password </title>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="ml-lg-5">
                <form action="<?php echo base_url()?>index.php/Password/recover_password" method="post" class="p-sm-3">
                
                    <?php if($error=$this->session->flashdata('recovery_failure')){
                    ?><div class="alert alert-dismissible alert-danger">
                    <?=$error ?> 
                    </div>  
                    <?php }
                    ?>                       
                    <?php if($error=$this->session->flashdata('recovery_success')){
            ...
            <div class="form-group mt-4 mb-4">
                <label for="useremail" class="col-form-label">Enter Registered Email</label>
                <input type="text" class="form-control" placeholder="" name="useremail" id="useremail" >
                <?php echo form_error('useremail',"<p  style='font-size: 12px;' class='text-danger'>","</p>"); ?>
            </div>

            
            <div class="right-w3l mt-4 mb-4">
                <input type="submit" class="form-control bg-theme" value="Recover Password">
            </div>
